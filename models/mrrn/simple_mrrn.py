...
class SimpleMRRNstructionLayer(nn.Module):
    def __init__(self,
                 inplanes,
                 instrides,
                 num_residual_layers,
        ...
        super(SimpleMRRNstructionLayer, self).__init__()
    ...
    def forward(self, inputs,train=False):
        ...
        mrrn_feats={ block_name:getattr(self,'{}_mrrn'.format(block_name))(block_feats[block_name]) for block_name in block_feats}
        residual={ block_name: (block_feats[block_name]- mrrn_feats[block_name] )**2 for block_name in block_feats}
