...
# To train fsdnet, 1*24G GPU is required.
...
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset MPDD --class_name bracket_black
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset MPDD --class_name bracket_brown
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset MPDD --class_name bracket_white
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset MPDD --class_name connector
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset MPDD --class_name metal_plate
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset MPDD --class_name tubes

python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset BTAD --class_name 01
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset BTAD --class_name 02
python -m torch.distributed.launch --nproc_per_node=1  train_fsdnet.py --dataset BTAD --class_name 03


# To evaluation fsdnet, visualize and calculate PRO, 1*24G GPU is required.
...
python  evaluation_fsdnet.py --dataset VisA --class_name candle
python  evaluation_fsdnet.py --dataset VisA --class_name capsules
python  evaluation_fsdnet.py --dataset VisA --class_name cashew
python  evaluation_fsdnet.py --dataset VisA --class_name chewinggum
python  evaluation_fsdnet.py --dataset VisA --class_name fryum
python  evaluation_fsdnet.py --dataset VisA --class_name macaroni1
python  evaluation_fsdnet.py --dataset VisA --class_name macaroni2
python  evaluation_fsdnet.py --dataset VisA --class_name pcb1
python  evaluation_fsdnet.py --dataset VisA --class_name pcb2
python  evaluation_fsdnet.py --dataset VisA --class_name pcb3
python  evaluation_fsdnet.py --dataset VisA --class_name pcb4
python  evaluation_fsdnet.py --dataset VisA --class_name pipe_fryum

python  evaluation_fsdnet.py --dataset MPDD --class_name bracket_black
python  evaluation_fsdnet.py --dataset MPDD --class_name bracket_brown
python  evaluation_fsdnet.py --dataset MPDD --class_name bracket_white
python  evaluation_fsdnet.py --dataset MPDD --class_name connector
python  evaluation_fsdnet.py --dataset MPDD --class_name metal_plate
python  evaluation_fsdnet.py --dataset MPDD --class_name tubes

python  evaluation_fsdnet.py --dataset BTAD --class_name 01
python  evaluation_fsdnet.py --dataset BTAD --class_name 02
python  evaluation_fsdnet.py --dataset BTAD --class_name 03